...
public class Productmain {
	...
	public static void main(String[] args) {   
		Product p1=new Product(1,"Sony",15000);//adding product details
		Product p2=new Product(2,"Onida",1000);
		Product p3=new Product(3,"lenovo",8000);
		Product p4=new Product(4,"Samsung",9000);
