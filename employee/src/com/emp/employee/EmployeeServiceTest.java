...
public class EmployeeServiceTest {
	...
	{
		//way 1
//		employeeService.addEmployee(123, "Akshay", 25000, "Pune"," India" );
//		employeeService.addEmployee(199, "Satvik", 30000, "nashik," India" );
//		assertEquals(2,employeeService.lenghtOfList());
		
		//way 2
		Address add=Address.builder().city("Pune").country("India").build();
		Employee emp=Employee.builder().empId(123).name("Satvik").salary(25000).address(add).build();
		employeeService.addEmp(emp);
		Employee e=employeeService.displayEmpById(123);
		//assertEquals("Satvik",e.getName());
	...
	void testUpdateEmployee()
	{
		...
		//assertEquals("Atish",e.getName());
		assertThat(e.getName()).isEqualTo("Atish");
	}
	...
	void testRemoveById()
	{
		...
		//assertEquals("Satvik",employeeService.findId(123).getName());
	...
	{
		Address add= Address.builder().city("Pune").country("India").build();
		Employee emp= Employee.builder().empId(123).name("Satvik").salary(35000).address(add).build();
		employeeService.addEmp(emp);
